...
const API = {
    ticks: `${API_BASE}/ticks`,
    trades: `${API_BASE}/testing/trades`,
    summary: `${API_BASE}/testing/summary`,
    reset: `${API_BASE}/testing/reset`,
    coach: `${API_BASE}/testing/coach`,
    decision: (symbol: string, timeframe: string) => `${API_BASE}/signals/decision/${symbol}?timeframe=${timeframe}`,
};
...
export default function TestingPage() {
    ...
    const buildCoachSignal = (trade: Trade, livePnl: number): CoachSignal | null => {
    ...
    const runCoach = useCallback(
        ...
        [computeLivePnl, enrichCoachSignals]
    );
                        ...
                        <article className={styles.card}>
                            ...
                            <div className={styles.cardBd}>
                                ...
                                <div className={styles.rowActions} style={{ marginTop: 10 }}>
                                    <button className={styles.btn} type="button" onClick={() => void useLivePrice()}>Use Live Price</button>
