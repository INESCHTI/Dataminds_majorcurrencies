...
// Agent configs (DSO1.1 / DSO1.2 / DSO1.3 / DSO1.4)
const AGENTS = {
    technical: {
    ...
    geopolitical: {
        icon: Shield, color: "text-violet-400", bg: "bg-violet-500/10",
        border: "border-violet-500/20", gradient: "from-violet-500 to-purple-500",
        name: "Geopolitical Agent", dso: "DSO1.4",
        description: "Political events - Crisis detection - Safe-haven analysis - Risk sentiment",
        weight: 25,
        bio: "Analyzes political events, crises, and geopolitical tensions to determine safe-haven vs risk-on currency flows, with focus on USD, CHF, JPY as safe-havens vs EUR, GBP, AUD as risk currencies.",
    },
};
    ...
    return (
        <div className="flex flex-col h-full bg-[#080d18] text-slate-100 relative overflow-hidden">
            ...
            <div className="relative z-10 flex-1 overflow-auto p-6 space-y-6">
                    ...
                    <FadeInUp>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            {[
                                ...
                                { label: "Active agents", value: `${Object.keys(health.agent_performances).length}/4`, dot: "violet" as const, sub: "Technical - Macro - Sentiment - Geopolitical" },
                ...
                {/* Agent Cards (DSO1.1 + DSO1.2 + DSO1.3 + DSO1.4) */}
                <div>
                    <FadeInUp delay={0.1}>
                        <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4">
                            Multi-Agent Architecture - DSO2.1 Weighting (4 Agents)
                        </h3>
                    </FadeInUp>
                            ...
                            return (
                                <StaggerItem key={key}>
                                    <SpotlightCard
                                        ...
                                        spotlightColor={`rgba(${key === "technical" ? "16,185,129" : key === "macro" ? "59,130,246" : key === "sentiment" ? "245,158,11" : "139,92,246"},0.1)`}
                                    >
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <AnimatedProgressBar value={agent.weight} color={key === "technical" ? "emerald" : key === "macro" ? "blue" : key === "sentiment" ? "amber" : "violet"} height={3} />
                                        </div>
                                        ...
                                        {vote && (
                                            <div className="mt-3 pt-3 border-t border-white/5">
                                                ...
                                                <AnimatedProgressBar value={vote.confidence * 100} color={key === "technical" ? "emerald" : key === "macro" ? "blue" : key === "sentiment" ? "amber" : "violet"} height={3} />
                ...
                {!signal && !loading && (
                    <FloatingCard delay={0.2}>
                        <div className="rounded-xl border border-white/5 bg-white/[0.03] p-12 text-center">
                            ...
                            <p className="text-xs font-bold text-white mb-2">Signal Lab Ready</p>
                            <p className="text-sm text-slate-500 mb-6 max-w-md mx-auto">
                                Select a currency pair and click <strong className="text-violet-400">Generate Signal</strong> to run the 4-agent multi-agent system.
                            </p>
                            <div className="flex flex-wrap gap-2 justify-center text-[11px] text-slate-600">
                                ...
                                <span className="px-2 py-1 rounded border border-violet-500/20 bg-violet-500/5">DSO1.4 Geopolitical Analysis</span>
